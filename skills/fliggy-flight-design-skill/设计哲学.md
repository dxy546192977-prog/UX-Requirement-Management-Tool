...
| 组件 | 说明 | 物料路径 |
|------|------|---------|
| 导航栏 | 固定顶部，含返回/标题/操作区 | `机票四连跳/Fliggy Design Skill/框架组件.md` 第1节 |
| 底部输入区 | 固定底部，258px 含安全区 | `机票四连跳/Fliggy Design Skill/框架组件.md` 第2节 |
| 输入气泡 | 用户 query 展示，靠右对齐 | `机票四连跳/Fliggy Design Skill/框架组件.md` 第3节 |
| 点赞与分享 | 每轮 AI 回复末尾 | `机票四连跳/Fliggy Design Skill/框架组件.md` 第4节 |
| 追问组件 | 引导追问词条 | `机票四连跳/Fliggy Design Skill/框架组件.md` 第5节 |

**输出组件**（AI 回复中的内容卡片）：

| 组件 | 说明 | 物料路径 |
|------|------|---------|
| 交通卡 | 航班信息展示（航司+时刻+价格） | `机票四连跳/Fliggy Design Skill/输出组件/交通卡/` |
| 商品卡 | 通用商品展示 | `机票四连跳/Fliggy Design Skill/输出组件/商品卡/` |
| 下单卡 | 下单确认信息 | `机票四连跳/Fliggy Design Skill/输出组件/下单卡/` |
| 订单卡 | 订单状态展示 | `机票四连跳/Fliggy Design Skill/输出组件/订单卡/` |
| 酒店房型卡 | 酒店房型信息 | `机票四连跳/Fliggy Design Skill/输出组件/酒店房型卡/` |
| 选择器 | 选项选择交互 | `机票四连跳/Fliggy Design Skill/输出组件/选择器/` |
| 按钮 | 操作按钮 | `机票四连跳/Fliggy Design Skill/输出组件/按钮/` |
| 表格 | 数据表格展示 | `机票四连跳/Fliggy Design Skill/输出组件/表格/` |
| 文本 | 富文本内容 | `机票四连跳/Fliggy Design Skill/输出组件/文本/` |
| 图片 | 图片展示 | `机票四连跳/Fliggy Design Skill/输出组件/图片/` |
