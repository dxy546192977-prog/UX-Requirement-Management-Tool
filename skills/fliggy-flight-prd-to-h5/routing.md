...
|---|---|---|---|---|
| home | `vertical.flight.home` | `skills/fliggy-flight-design-guide/playbooks/flight-funnel/1 首页/首页.html` | supported | 正常执行 |
| booking | `vertical.flight.booking` | `skills/fliggy-flight-design-guide/playbooks/flight-funnel/3 下单页/下单页.html` | supported | 正常执行 |
...
```json
{
  ...
  "resolved_baseline_artifact": "skills/fliggy-flight-design-guide/playbooks/flight-funnel/1 首页/首页.html",
