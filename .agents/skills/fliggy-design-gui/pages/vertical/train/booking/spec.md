# 火车票下单（`vertical.train.booking`）— 页面结构

## 元信息

- **page_id**：`vertical.train.booking`（与 [docs/page-index.md](../../../../docs/page-index.md) 一致时引用）
...
火车票下单页：顶部导航、权益胶囊、行程卡、乘车人、选座选车厢、优惠信息、法务说明与底部支付栏。
...
| 日期 | 说明 |
|------|------|
| 2026-04-13 | 新增 `booking/example.html` 与 `booking/spec.md`，按提供稿落库。 |
