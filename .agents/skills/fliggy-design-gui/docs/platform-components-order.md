...
| 32 | 小组件 | 双列推荐 Feeds | `feeds-dual-column` | `components/platform/widgets/feeds-dual-column/` |
...
**序号 32 已落地**：`feeds-dual-column`（双排推荐 `fdl-feeds-dual`：750 灰底条、336 双列、Banner/卡片与头图标签·位置·播放·评价条等）。  
