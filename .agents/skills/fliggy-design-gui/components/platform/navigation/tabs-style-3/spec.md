...
- **依赖**：[`foundations/design-foundations.md`](../../../../foundations/design-foundations.md)；示例配图可选 [`foundations/image-library.md`](../../../../foundations/image-library.md)  
- **最后同步**：2026-04-05  
...
**横向滚动的胶囊 Tabs**（列表始终 **`overflow-x: auto`**、**`gap: 12`**、隐藏滚动条）。**双档尺寸**：**`fdl-tabs-style-3--sm`** 半透明白底 + 选中靛浅底与靛字（可用于 **叠图场景**，也可用于 **纯色背景**）；**`fdl-tabs-style-3--lg`** 白底深字 + 选中 **品牌黄**（适合 **浅灰/白页内筛选**）。定位 **次级 / 三级筛选或子分类**，一般不作应用主导航。
...
- **小档**：头图、Banner 下沿、半透明顶栏下方等 **需要透底** 的区域，也可用于白/浅灰等纯色背景。  
...
| 2026-04-07 | 放开小档使用场景：`--sm` 不再限定叠图，可用于纯色背景。 |
