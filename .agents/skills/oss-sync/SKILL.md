...
```bash
# 本地 → 线上（最常用）
node .Codex/skills/oss-sync/scripts/oss-sync.mjs push

# 线上 → 本地
node .Codex/skills/oss-sync/scripts/oss-sync.mjs pull

# 查看状态
node .Codex/skills/oss-sync/scripts/oss-sync.mjs status
```
